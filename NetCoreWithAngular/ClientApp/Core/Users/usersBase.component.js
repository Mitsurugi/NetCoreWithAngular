...
var UsersBaseComponent = /** @class */ (function () {
    function UsersBaseComponent(service, typeGrid, typeCreate, typeEdit, typeFilter) {
        this._currentPage = 1;
        this._pageSize = 5;
        this._totalPages = 1;
        this._message = null;
    ...
    UsersBaseComponent = __decorate([
        Component({}),
        __metadata("design:paramtypes", [UsersService, Function, Function, Function, Function])
    ], UsersBaseComponent);
